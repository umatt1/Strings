...
const CAGED_C_MAJOR = [
  {
    shapeName: 'E Shape',
    notes: { 6: [8, 10], 5: [7, 8, 10], 4: [7, 9, 10], 3: [7, 9, 10], 2: [8, 10], 1: [7, 8] },
  },
  {
    shapeName: 'D Shape',
    notes: { 6: [10, 12, 13], 5: [10, 12, 14], 4: [10, 12, 14], 3: [10, 12], 2: [10, 12, 13], 1: [10, 12, 13] },
  },
  {
    shapeName: 'C Shape',
  ...
  {
    shapeName: 'A Shape',
    notes: { 6: [3, 5], 5: [2, 3, 5], 4: [2, 3, 5], 3: [2, 4, 5], 2: [3, 5], 1: [1, 3] },
  },
  {
    shapeName: 'G Shape',
...
const CAGED_G_MAJOR = [
  {
    shapeName: 'E Shape',
    notes: { 6: [3, 5], 5: [2, 3, 5], 4: [2, 4, 5], 3: [2, 4, 5], 2: [3, 5], 1: [2, 3] },
  },
  {
    shapeName: 'D Shape',
    notes: { 6: [5, 7, 8], 5: [5, 7, 9], 4: [5, 7, 9], 3: [5, 7], 2: [5, 7, 8], 1: [5, 7, 8] },
  },
  {
    shapeName: 'C Shape',
  ...
  {
    shapeName: 'A Shape',
    notes: { 6: [10, 12], 5: [9, 10, 12], 4: [9, 10, 12], 3: [9, 11, 12], 2: [10, 12], 1: [8, 10] },
  },
  {
    shapeName: 'G Shape',
...
const CAGED_A_MAJOR = [
  {
    shapeName: 'E Shape',
    notes: { 6: [5, 7], 5: [4, 5, 7], 4: [4, 6, 7], 3: [4, 6, 7], 2: [5, 7], 1: [4, 5] },
  },
  {
    shapeName: 'D Shape',
    notes: { 6: [7, 9, 10], 5: [7, 9, 11], 4: [7, 9, 11], 3: [7, 9], 2: [7, 9, 10], 1: [7, 9, 10] },
  },
  {
    shapeName: 'C Shape',
  ...
  {
    shapeName: 'A Shape',
    notes: { 6: [12, 14], 5: [11, 12, 14], 4: [11, 12, 14], 3: [11, 13, 14], 2: [12, 14], 1: [10, 12] },
  },
  {
    shapeName: 'G Shape',
